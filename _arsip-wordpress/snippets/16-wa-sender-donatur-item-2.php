<?php
// SNIPPET WordPress #16: WA Sender Donatur (Item 2)
...
function wa_donatur_data_callback() {
    ...
    echo '<h3>' . ($edit_data ? 'Edit Kontak' : 'Tambah Manual') . '</h3><form method="post" action="?page=wa-modul-donatur">';
...
function wa_donatur_template_callback() {
    ...
    echo '<form method="post" action="?page=wa-modul-template">';
